        ...
        <main className="flex-1 overflow-y-auto p-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-5 mb-6">
            ...
            <StatCard
              ...
              sub={revNeutral ? 'No sales yet today' : `${stats.revenue_change >= 0 ? '+' : ''}${stats.revenue_change}% from yesterday`}
            ...
            <StatCard
              ...
              sub={salesNeutral ? 'No transactions today' : `${stats.sales_change >= 0 ? '+' : ''}${stats.sales_change}% from yesterday`}
...
function StatCard({ label, value, sub, positive, icon, iconBg, onClick }) {
  return (
    <div
      className={`stat-card flex items-start gap-4 ${onClick ? 'cursor-pointer hover:shadow-md transition-shadow' : ''}`}
      onClick={onClick}
    >
